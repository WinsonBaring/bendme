    ...
    <main id="main">
      ...
      <section className="help section wrap" id="help" aria-labelledby="help-title">
        ...
        <div className="questions">
          <details><summary>How do I start the effect?<ChevronDown size={18} aria-hidden="true" /></summary><p>Open BendMe and follow its interactive Setup guide. It helps you install the app, opens the right Screen Recording settings, and keeps a small visual guide beside System Settings. If BendMe is missing from the list, choose “BendMe isn’t listed” for help adding it. BendMe checks access and walks you through your first live effect. You can reopen Setup from the sidebar or menu bar any time.</p></details>
