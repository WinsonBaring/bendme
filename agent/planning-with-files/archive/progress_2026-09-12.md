...
## 2026-09-12 light theme and sidebar [Issue #10]
- Interpreted user’s “while” as white/light and stated assumption. Inspected original reference for blue accents and Apple focusEffectDisabled docs. Added shared AppTheme, light cards/sidebar/Aqua window and consistent full-row sidebar focus/selection.
- First Appearance fixture exposed default focus staying on Setup; aligned default/programmatic focus to selected page. Fixture shader was missing; copied resource in harness. Final eleven layouts rendered, Setup/Appearance reviewed; prior 17 tests passed. GPU layers are omitted by bitmap snapshots. No install, permission or release changes.
