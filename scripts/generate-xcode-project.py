...
phase_shader = add("phase shader", "PBXShellScriptBuildPhase", buildActionMask="2147483647", files=[], name="Bundle app resources", inputPaths=["$(SRCROOT)/Sources/BendMe/Resources/Fold.metal", "$(SRCROOT)/Sources/BendMe/Resources/GitHub-Mark.png", "$(SRCROOT)/Sources/BendMe/Resources/BendMeLogo.png"], outputPaths=["$(TARGET_BUILD_DIR)/$(UNLOCALIZED_RESOURCES_FOLDER_PATH)/BendMe_BendMe.bundle/Resources/Fold.metal", "$(TARGET_BUILD_DIR)/$(UNLOCALIZED_RESOURCES_FOLDER_PATH)/BendMe_BendMe.bundle/Resources/GitHub-Mark.png", "$(TARGET_BUILD_DIR)/$(UNLOCALIZED_RESOURCES_FOLDER_PATH)/BendMe_BendMe.bundle/Resources/BendMeLogo.png"], runOnlyForDeploymentPostprocessing="0", shellPath="/bin/sh", shellScript='set -eu\ndestination="${TARGET_BUILD_DIR}/${UNLOCALIZED_RESOURCES_FOLDER_PATH}/BendMe_BendMe.bundle/Resources"\nmkdir -p "$destination"\ncp "${SRCROOT}/Sources/BendMe/Resources/Fold.metal" "$destination/Fold.metal"\ncp "${SRCROOT}/Sources/BendMe/Resources/GitHub-Mark.png" "$destination/GitHub-Mark.png"\ncp "${SRCROOT}/Sources/BendMe/Resources/BendMeLogo.png" "$destination/BendMeLogo.png"\n')
