...
Current app version is 0.1.2/build 3. Dock activation is enabled in distribution/Info.plist and the app lifecycle; archives can be isolated with BENDME_NOTARIZATION_DIR.
